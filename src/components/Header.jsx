...
export const Header = () => {
  ...
  return (
    ...
    <div className="flex flex-col md:flex-row items-center justify-between border-b-2 border-gray-300 dark:border-slate-950 pb-5">
      <h1 className="font-black text-4xl text-center  mx-auto dark:text-white mt-5">Seguimiento Pacientes {''}
        <span className="text-sky-600">Veterinaria</span>
      </h1>


      <label className="switch mr-5 mt-7">
        ...
        <span className="slider" onClick={handleChangeTheme}></span>
      </label>
